...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN','https://web-iunnseqs7qml.up-de-fra1-k8s-1.apps.run-on-seenode.com/') else APP_NAME+'.herokuapp.com'
...
class Config(object):
	...
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002276555116))
	...
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002276555116")
